...
public class MainServidor {
	private static final String ARCHIVO_CONFIG = "server.json";
	public static final String APRENDER_HECHIZO_RESET = null;
	public static final byte RESET_APRENDER_OMEGA = 0;
	...
	// PARAMETROS
	public static boolean PARAM_NERFEAR_STATS_EXOTICOS;	
	...
	public static CopyOnWriteArrayList<String> PARAMETROS_CONFIG_CUSTOM = new CopyOnWriteArrayList<>();
	...
	public static String BD_PUERTO = "3306";
	public static String BD_HOST_DINAMICA;
	...
	// LIMITES
	public static int LIMITE_MAPAS = 35000;
	...
	public static void main(final String[] args) {
		...
		System.out.println("\u001B[31m|            GAME SERVIDOR V1.47.5            |\u001B[0m"); 
		System.out.println("\u001B[31m ---------------------------------------------\u001B[0m"); 		
		System.out.println("");			
		System.out.println("\t\t\u001B[32mCreado Por:\u001B[0m \u001B[33mAemux\u001B[0m");	
		System.out.println("");		
		System.out.println("\t\u001B[5m\u001B[31m[!] Inicializando modulos...\u001B[0m");
		...
		System.out.print("\u001B[32mInicializando Módulo MultiServidor: \u001B[0m");
		...
		System.out.println("");
		System.out.print("\u001B[32mInicializando Módulo GameServidor: \u001B[0m");
		...
		System.out.println(GREEN +"Esperando que los jugadores se conecten:");
	}
	
	private static void leyendoIpsPermitidas() {

		if (!GestorSQL.iniciarConexionAlterna()) {
			return;
		}
		IP_PERMTIDAS = GestorSQL.LISTA_IP_PERMITIDA();
		cargarConfiguracionIP(null);
		GestorSQL.CARGAR_PARAMS_CUSTOM();
		GestorSQL.CARGAR_PARAMS_CUSTOM(IP_MULTISERVIDOR2.get(0));
		GestorSQL.cerrarConexionAlterna();
	}
	
/*	private static void leyendoIpsPermitidas() { //oldip 1
				...
				try {
					...
					switch (parametro.toUpperCase()) {
						...
						case "PARAM_ANTI_SPEEDHACK" :
							...
							case "PARAM_NERFEAR_STATS_EXOTICOS":
							PARAM_NERFEAR_STATS_EXOTICOS = valor.equalsIgnoreCase("true");
							variable = "PARAM_NERFEAR_STATS_EXOTICOS";
						    break;
	...
	public static void cargarConfiguracionIP(Personaje perso) {
			...
			while ((linea = config.readLine()) != null) {
				try {
					...
					case "IP_PUBLICA_SERVIDOR":
						...
						if (IP_PERMTIDAS.contains(valor) || IP_PERMTIDAS.contains("*")) {
							try {
								InetAddress in = InetAddress.getByName(valor);
								IP_PUBLICA_SERVIDOR = in.getHostAddress();
							} catch (Exception e) {
								IP_PUBLICA_SERVIDOR = valor;
							}
						}
		...
		if (IP_MULTISERVIDOR.isEmpty()) {
			IP_MULTISERVIDOR.add("127.0.0.1"); //aqui pon tu IP, conexion vps
