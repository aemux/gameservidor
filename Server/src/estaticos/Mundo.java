...
import variables.zotros.MasterReset;
...
public class Mundo {
	...
	public static Map<Integer, MasterReset> MASTER_RESET = new TreeMap<>();
	...
	public static void crearServidor() {
		try {
			System.out.println(
				    "\u001B[32mTotalMemory:\u001B[0m " + 
				    "\u001B[33m" + (Runtime.getRuntime().totalMemory() / 1048576f) + " MB\u001B[0m\t" + 
				    "\u001B[32mMaxMemory:\u001B[0m " + 
				    "\u001B[33m" + (Runtime.getRuntime().maxMemory() / 1048576f) + " MB\u001B[0m"
				);
		...
		System.out.println("");
		System.out.print("\u001B[32mInicializando Módulo Estatico: \u001B[0m");
		System.out.println("Modulo Exitoso");
		System.out.println("");
		...
		System.out.print(GREEN + "Cargando las clases: " + RESET);
		GestorSQL.CARGAR_CLASES();
		System.out.println(YELLOW + CLASES.size() + " clases cargadas"+ RESET);
		...
		System.out.print(GREEN + "Cargando los servicios: " + RESET);
		GestorSQL.CARGAR_SERVICIOS();
		System.out.println(YELLOW + SERVICIOS.size() + " servicios cargados" + RESET);
		
		System.out.print(GREEN + "Cargando los ornamentos: " + RESET);
		GestorSQL.CARGAR_ORNAMENTOS();
		System.out.println(YELLOW + YELLOW + ORNAMENTOS.size() + " ornamentos cargados" + RESET);
		
		System.out.print(GREEN + "Cargando los titulos: " + RESET);
		GestorSQL.CARGAR_TITULOS();
		System.out.println(YELLOW + YELLOW + TITULOS.size() + " titulos cargados" + RESET);
		
		System.out.print(GREEN + "Cargando los comandos modelo: " + RESET);
		GestorSQL.CARGAR_COMANDOS_MODELO();
		System.out.println(YELLOW + COMANDOS.size() + " comandos modelo cargados" + RESET);
		System.out.print(GREEN + "Cargando los dones: " + RESET);
		GestorSQL.CARGAR_DONES_MODELOS();
		System.out.println(YELLOW + DONES_MODELOS.size() + " dones cargados" + RESET);
		System.out.print(GREEN + "Cargando las especialidades: " + RESET);
		GestorSQL.CARGAR_ESPECIALIDADES();
		System.out.println(YELLOW + ESPECIALIDADES.size() + " especialidades cargadas" + RESET);
		System.out.print(GREEN + "Cargando los misiones almanax: " + RESET);
		GestorSQL.CARGAR_ALMANAX();
		System.out.println(YELLOW + ALMANAX.size() + " almanax cargados" + RESET);
		System.out.print(GREEN + "Cargando los niveles de experiencia: " + RESET);
		...
		System.out.println(YELLOW + EXPERIENCIA.size() + " niveles cargados" + RESET);
		System.out.print(GREEN + "Cargando los hechizos: " + RESET);
		GestorSQL.CARGAR_HECHIZOS();
		System.out.println(YELLOW + HECHIZOS.size() + " hechizos cargados" + RESET);
		System.out.print(GREEN + "Cargando las encarnaciones modelos: " + RESET);
		GestorSQL.CARGAR_ENCARNACIONES_MODELOS();
		System.out.println(YELLOW + ENCARNACIONES_MODELOS.size() + " encarnaciones modelo cargados" + RESET);
		System.out.print(GREEN + "Cargando los mounstros: " + RESET);
		GestorSQL.CARGAR_MOBS_MODELOS();
		GestorSQL.CARGAR_MOBS_RAROS();
		GestorSQL.CARGAR_MOBS_EVENTO();
		System.out.println(YELLOW + MOBS_MODELOS.size() + " mounstros cargados" + RESET);
		System.out.print(GREEN + "Cargando los objetos modelos: " + RESET);
		GestorSQL.CARGAR_OBJETOS_MODELOS();
		System.out.println(YELLOW + OBJETOS_MODELOS.size() + " objetos modelos cargados" + RESET);
		System.out.print(GREEN + "Cargando los sets de objetos: " + RESET);
		GestorSQL.CARGAR_OBJETOS_SETS();
		System.out.println(YELLOW + OBJETOS_SETS.size() + " set de objetos cargados" + RESET);
		System.out.print(GREEN + "Cargando las monturas modelos: " + RESET);
		GestorSQL.CARGAR_MONTURAS_MODELOS();
		System.out.println(YELLOW + MONTURAS_MODELOS.size() + " monturas modelos cargados" + RESET);
		System.out.print(GREEN + "Cargando los objetos trueque: " + RESET);
		GestorSQL.CARGAR_OBJETOS_TRUEQUE();
		System.out.println(YELLOW + OBJETOS_TRUEQUE.size() + " objetos trueque cargados" + RESET);
		System.out.print(GREEN + "Cargando los drops: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_DROPS() + " drops cargados" + RESET);
		System.out.print(GREEN + "Cargando los drops fijos: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_DROPS_FIJOS() + " drops fijos cargados" + RESET);
		System.out.print(GREEN + "Cargando los NPC: " + RESET);
		GestorSQL.CARGAR_NPC_MODELOS();
		System.out.println(YELLOW + NPC_MODELOS.size() + " NPC cargados" + RESET);
		System.out.print(GREEN + "Cargando las preguntas de NPC: " + RESET);
		GestorSQL.CARGAR_PREGUNTAS();
		System.out.println(YELLOW + NPC_PREGUNTAS.size() + " preguntas de NPC cargadas" + RESET);
		System.out.print(GREEN + "Cargando las respuestas de NPC: " + RESET);
		GestorSQL.CARGAR_RESPUESTAS();
		System.out.println(YELLOW + NPC_RESPUESTAS.size() + " respuestas de NPC cargadas" + RESET);
		System.out.print(GREEN + "Cargando las areas: " + RESET);
		GestorSQL.CARGAR_AREA();
		System.out.println(YELLOW + AREAS.size() + " areas cargadas" + RESET);
		System.out.print(GREEN + "Cargando las sub-areas: " + RESET);
		GestorSQL.CARGAR_SUBAREA();
		System.out.println(YELLOW + SUB_AREAS.size() + " sub-areas cargadas" + RESET);
		System.out.print(GREEN + "Cargando los objetos interactivos: " + RESET);
		GestorSQL.CARGAR_INTERACTIVOS();
		System.out.println(YELLOW + OBJETOS_INTERACTIVOS_MODELOS.size() + " objetos interactivos cargados" + RESET);
		System.out.print(GREEN + "Cargando las recetas: " + RESET);
		GestorSQL.CARGAR_RECETAS();
		System.out.println(YELLOW + RECETAS.size() + " recetas cargadas" + RESET);
		System.out.print(GREEN + "Cargando los oficios: " + RESET);
		GestorSQL.CARGAR_OFICIOS();
		System.out.println(YELLOW + OFICIOS.size() + " oficios cargados" + RESET);
		System.out.print(GREEN + "Cargando los objetivos: " + RESET);
		GestorSQL.CARGAR_MISION_OBJETIVOS();
		System.out.println(YELLOW + OBJETIVOS_MODELOS.size() + " objetivos cargados" + RESET);
		System.out.print(GREEN + "Cargando las etapas: " + RESET);
		GestorSQL.CARGAR_ETAPAS();
		System.out.println(YELLOW + ETAPAS.size() + " etapas cargadas" + RESET);
		System.out.print(GREEN + "Cargando los misiones: " + RESET);
		GestorSQL.CARGAR_MISIONES();
		System.out.println(YELLOW + MISIONES_MODELOS.size() + " misiones cargados" + RESET);
		GestorSQL.CARGAR_MAPAS_ESTRELLAS();
		if (MainServidor.MODO_HEROICO || !MainServidor.MAPAS_MODO_HEROICO.isEmpty()) {
			System.out.print(GREEN + "Cargando los mapas heroicos: " + RESET);
			GestorSQL.CARGAR_MAPAS_HEROICO();
			System.out.println(YELLOW + MAPAS_HEROICOS.size() + " mapas heroicos cargados" + RESET);
		}
		System.out.print(GREEN + "Cargando los mapas: " + RESET);
		long xxxx = System.currentTimeMillis();
		GestorSQL.CARGAR_MAPAS();
		System.out.println(YELLOW + MAPAS.size() + " mapas cargados ----> (en " + (System.currentTimeMillis() - xxxx) + ") milisegundos" + RESET);
		System.out.print(GREEN + "Cargando los grupo mobs fijos: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_MOBS_FIJOS() + " grupo mobs fijos cargados" + RESET);
		System.out.print(GREEN + "Cargando los zaaps: " + RESET);
		GestorSQL.CARGAR_ZAAPS();
		System.out.println(YELLOW + ZAAPS.size() + " zaaps cargados" + RESET);
		System.out.print(GREEN + "Cargando los triggers: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_TRIGGERS() + " trigger cargados" + RESET);
		System.out.print(GREEN + "Cargando las acciones de pelea: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_ACCION_FINAL_DE_PELEA() + " acciones de pelea cargadas" + RESET);
		System.out.print(GREEN + "Cargando los NPCs: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_NPCS() + " NPCs cargados" + RESET);
		System.out.print(GREEN + "Cargando las acciones de objetos: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_ACCIONES_USO_OBJETOS() + " acciones de objetos cargados" + RESET);
		System.out.print(GREEN + "Cargando las animaciones: " + RESET);
		GestorSQL.SELECT_ANIMACIONES();
		System.out.println(YELLOW + ANIMACIONES.size() + " animaciones cargadas" + RESET);
		System.out.print(GREEN + "Cargando los otros interactivos: " + RESET);
		GestorSQL.CARGAR_OTROS_INTERACTIVOS();
		System.out.println(YELLOW + OTROS_INTERACTIVOS.size() + " otros interactivos cargados" + RESET);
		System.out.print(GREEN + "Cargando las comidas de mascotas: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_COMIDAS_MASCOTAS() + " comidas de mascotas cargadas" + RESET);
		System.out.print(GREEN + "Cargando los tutoriales: " + RESET);
		GestorSQL.CARGAR_TUTORIALES();
		System.out.println(YELLOW + TUTORIALES.size() + " tutoriales cargados" + RESET);
		System.out.print(GREEN + "Cargando las zonas: " + RESET);
		GestorSQL.SELECT_ZONAS();
		System.out.println(YELLOW + ZONAS.size() + " zonas cargados" + RESET);
		System.out.println(YELLOW + "" + RESET);
		System.out.print(GREEN + "\u001B[32mInicializando Módulo Dinamico: \u001B[0m" + RESET);
		System.out.println(YELLOW + "Modulo Exitoso" + RESET);
		System.out.println(YELLOW + "" + RESET);
		System.out.print(GREEN + "Cargando los objetos: " + RESET);
		GestorSQL.CARGAR_OBJETOS();
		System.out.println(YELLOW + _OBJETOS.size() + " objetos cargados" + RESET);
		System.out.print(GREEN + "Cargando los dragopavos: " + RESET);
		GestorSQL.CARGAR_MONTURAS();
		System.out.println(YELLOW + _MONTURAS.size() + " dragopavos cargados" + RESET);
		System.out.print(GREEN + "Cargando los puesto mercadillos: " + RESET);
		GestorSQL.SELECT_PUESTOS_MERCADILLOS();
		System.out.println(YELLOW + MERCADILLOS.size() + " puestos mercadillos cargados" + RESET);
		System.out.print(GREEN + "Cargando las cuentas: " + RESET);
		GestorSQL.CARGAR_DB_CUENTAS();
		GestorSQL.CARGAR_CUENTAS_SERVER_PERSONAJE();
		System.out.println(YELLOW + _CUENTAS.size() + " cuentas cargadas" + RESET);
		System.out.print(GREEN + "Cargando los personajes: " + RESET);
		GestorSQL.CARGAR_PERSONAJES();
		System.out.println(YELLOW + _PERSONAJES.size() + " personajes cargados" + RESET);
		System.out.print(GREEN + "Cargando los objetos mercadillos: " + RESET);
		System.out.println(YELLOW + GestorSQL.SELECT_OBJETOS_MERCADILLO() + " objetos mercadillos cargados" + RESET);
		System.out.print(GREEN + "Cargando los rankings PVP: " + RESET);
		GestorSQL.SELECT_RANKING_PVP();
		System.out.println(YELLOW + _RANKINGS_PVP.size() + " rankings PVP cargados cargados" + RESET);
		System.out.print(GREEN + "Cargando los prismas: " + RESET);
		GestorSQL.CARGAR_PRISMAS();
		System.out.println(YELLOW + _PRISMAS.size() + " prismas cargados" + RESET);
		System.out.print(GREEN + "Cargando los rankings Koliseo: " + RESET);
		GestorSQL.SELECT_RANKING_KOLISEO();
		System.out.println(YELLOW + _RANKINGS_KOLISEO.size() + " rankings Koliseo cargados cargados" + RESET);
		System.out.print(GREEN + "Cargando los gremios: " + RESET);
		GestorSQL.CARGAR_GREMIOS();
		System.out.println(YELLOW + _GREMIOS.size() + " gremios cargados" + RESET);
		System.out.print(GREEN + "Cargando los miembros de gremio: " + RESET);
		System.out.println(YELLOW + GestorSQL.CARGAR_MIEMBROS_GREMIO() + " miembros de gremio cargados" + RESET);
		System.out.print(GREEN + "Cargando los recaudadores: " + RESET);
		GestorSQL.CARGAR_RECAUDADORES();
		System.out.println(YELLOW + _RECAUDADORES.size() + " recaudadores cargados" + RESET);
		System.out.print(GREEN + "Cargando los cercados: " + RESET);
		GestorSQL.CARGAR_CERCADOS();
		GestorSQL.RECARGAR_CERCADOS();
		System.out.println(YELLOW + CERCADOS.size() + " cercados cargados" + RESET);
			
		GestorSQL.CARGAR_TIENDA_CATEGORIA();
		System.out.print(GREEN + "Loading tienda categoria." + RESET);
		System.out.println(YELLOW + TiendaCategoria.size() + " tienda objetos" + RESET);
		
		GestorSQL.CARGAR_TIENDA_OBJETO();
		System.out.print(GREEN + "Loading tienda objetos." + RESET);
		System.out.println(YELLOW + TiendaObjetos.size() + " tienda objetos" + RESET);

		System.out.print(GREEN + "Cargando las casas: " + RESET);
		GestorSQL.CARGAR_CASAS();
		GestorSQL.RECARGAR_CASAS();
		System.out.println(YELLOW + CASAS.size() + " casas cargadas" + RESET);
		
		System.out.print(GREEN + "Cargando los cofres: " + RESET);		
		GestorSQL.CARGAR_COFRES();
		GestorSQL.RECARGAR_COFRES();
		System.out.println(YELLOW + COFRES.size() + " cofres cargados" + RESET);
	...
	public static MasterReset getMasterReset(int id) {
		return MASTER_RESET.get(id);
	}

	public static boolean getMasterResetExist(int id) {
