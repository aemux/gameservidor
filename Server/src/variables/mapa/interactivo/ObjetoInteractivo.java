...
public class ObjetoInteractivo {
	...
	//se recomiendra crear un usuario local con contraseña en la VPS, busca en youtube como crear un usuario local en xampp
	//conexion vps
		public static String BD_HOST_ALTERNA = "192.168.1.6"; 
		public static String BD_USER_ALTERNA = "jenny"; //usuario de la base de datos
		public static String BD_PASS_ALTERNA = "vps2025"; //contraseña de la base de datos
		public static String BD_ALTERNA = "emulador"; //no modificar
