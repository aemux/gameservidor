...
public class ServidorServer extends Thread {
	...
	public ServidorServer() {
		try {
			...
			System.out.println(GREEN +"Servidor Id:" + RESET+ YELLOW + MainServidor.SERVIDOR_ID + RESET);
			System.out.println(GREEN +"Puerto:" + YELLOW + MainServidor.PUERTO_SERVIDOR + RESET);
